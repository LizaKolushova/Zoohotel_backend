...
class AnimalTypeViewSet(viewsets.ViewSet):
    """
...
class AnimalPassportViewSet(viewsets.ViewSet):
    """
...
class VaccinationViewSet(viewsets.ViewSet):
    """
...
class TreatmentViewSet(viewsets.ViewSet):
    """
